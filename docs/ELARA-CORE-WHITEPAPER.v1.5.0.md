...
**Document Hash (SHA-256, v1.5.0):** *see previous version for hash chain*
...
**OpenTimestamps Proof:** `ELARA-CORE-WHITEPAPER.v1.5.0.md.ots`
**Companion Document:** `ELARA-PROTOCOL-WHITEPAPER.v0.5.0.md` — the universal validation protocol that Elara Core implements at Layer 3
