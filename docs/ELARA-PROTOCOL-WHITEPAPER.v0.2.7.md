...
**Layer 1 (local validation):** Negligible. Hashing + signing = milliseconds of CPU time. Energy cost: ~0.000183 Wh per validation on a smartphone (see Hardware Whitepaper v0.1.3, Section 10.2 for detailed breakdown). Comparable to sending a text message.
...
**Document Hash (SHA-256, v0.2.7):** `b9a249c93ae082b20269aa3bbd338d8e2740b15339ce473304f02c0ed81d166f`
...
**OpenTimestamps Proof:** `ELARA-PROTOCOL-WHITEPAPER.v0.2.7.md.ots`
