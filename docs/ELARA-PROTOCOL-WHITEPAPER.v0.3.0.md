...
- A **DAM Virtual Machine** with all 9 primitive operations defined in the Hardware Whitepaper (v0.1.6, Section 5.2): `DAM_INSERT`, `DAM_QUERY`, `DAM_WITNESS`, `DAM_HASH`, `DAM_SIGN`, `DAM_VERIFY`, `DAM_MERGE`, `DAM_CLASSIFY`, `DAM_ANALYZE`
...
- Layer 2 testnet (2-node end-to-end proof: record creation, sync, witness, trust scoring) — **shipped** (v0.11.0)
